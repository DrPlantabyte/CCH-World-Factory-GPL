 ...
 * given coordinate. This version uses floats instead of doubles for 
 * memory-limited or graphical applications (many graphics hardware 
 * implementations only have 32bit floating point precision).
 * @author Christopher Collin Hall
 */
public abstract class Abstract3FCoordinateNoiseGenerator {
	/**
